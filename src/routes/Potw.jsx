      ...
      <section style={{ ...backgroundStyle, paddingBottom: "2rem" }}>
        ...
        <div className="flex justify-center items-center ">
          <div className="lg:w-2/3 w-4/5">
            <div className="text-center shadow-lg p-10 rounded-xl lg:my-10 mt-10 bg-purple-300 transition-transform transform hover:scale-105">
              <h3 className="text-xl font-medium pt-8 pb-2">
                Player of the Week
              </h3>
              <p className="py-2 text-xl">Richie Viglione</p>
              <h4 className="py-4 text-orange-500 text-lg">Stats</h4>
        ...
        <div className="lg:flex gap-10 justify-center">
          <div className="text-center shadow-lg p-10 rounded-xl my-10 bg-purple-300 flex-2 transition-transform transform hover:scale-105 lg:w-2/5 w-4/5 mx-auto">
            <h3 className="text-xl font-medium pt-8 pb-2">
          ...
          <div className="text-center shadow-lg p-10 lg:my-10 rounded-xl  bg-yellow-300 flex-2 transition-transform transform hover:scale-105 lg:w-2/5 w-4/5 mx-auto">
            <h3 className="text-xl font-medium pt-8 pb-2">
