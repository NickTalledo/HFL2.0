function Footer() {
  return (
    <>
      ...
      <div className="px-4 py-6 bg-white dark:bg-gray-700 md:flex md:items-center md:justify-center">
        <div className="flex flex-col items-center justify-center text-center">
          <span className=" text-black dark:text-gray-300 mb-2">
            © 2023 HFL™. All Rights Reserved.
          </span>
